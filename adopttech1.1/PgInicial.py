...
class Application(tk.Tk):
    ...
    def cadastrar(self):
        ...
        self.cursor.execute("INSERT INTO Crianca (Nome_Crianca, RG, CPF, Data_entrada) VALUES (?, ?, ?, ?)",
                            (Nome_Crianca, rg, cpf, de))
        self.conn.commit()
    ...
    def consultar(self):
        self.cursor.execute("SELECT Nome_Crianca, RG, CPF, Data_entrada FROM Crianca")
        ...
        if len(resultados) == 0:
            ...
            for Nome_Crianca, rg, cpf, _ in sorted(resultados):

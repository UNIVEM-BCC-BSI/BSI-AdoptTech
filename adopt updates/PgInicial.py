...
class Application(tk.Tk):
    def __init__(self):
        ...
        photo = ImageTk.PhotoImage(image)
        consulta_button = tk.Button(opcao_frame, image=photo, command=self.abrir_janela_consulta, bg="#6598e4")
    ...
    def abrir_janela_consulta(self):
        ...
        self.janela_consulta.geometry('1024x768')
        self.janela_consulta.configure(bg='#6598e4')

        consultar_crianca_button = tk.Button(self.janela_consulta, text='Consultar Criança', command=self.consultar_crianca)
        consultar_crianca_button.pack(pady=20)

        consultar_adocao_button = tk.Button(self.janela_consulta, text='Consultar Adocao', command=self.consultar_adocao)
        consultar_adocao_button.pack(pady=20)

        consultar_familiaadot_button = tk.Button(self.janela_consulta, text='Consultar Familias Adotivas', command=self.consultar_familiaadotiva)
        consultar_familiaadot_button.pack(pady=20)

        consultar_familiabio_button = tk.Button(self.janela_consulta, text='Consultar Familias Biologicas',command=self.consultar_familiabio)
        consultar_familiabio_button.pack(pady=20)

        consultar_abandono_button = tk.Button(self.janela_consulta, text='Consultar Abandono', command=self.consultar_abandono)
        consultar_abandono_button.pack(pady=20)
    ...
    def abrir_janela_cadastro(self):
        ...
        image = Image.open('CADASTRO CRIANÇA.png')
        photo = ImageTk.PhotoImage(image)
        ...
        cadastrar_crianca_button.pack(pady=35)

        image = Image.open('CADASTRAR ADOÇÃO.png')
        photo = ImageTk.PhotoImage(image)
        ...
        cadastrar_adocao_button.pack(pady=35)

        image = Image.open('FAMILIA ADOTIVA.png')
        photo = ImageTk.PhotoImage(image)
        ...
        cadastrar_familiaadot_button.pack(pady=35)

        image = Image.open('FAMILIA BIOLOGICA.png')
        photo = ImageTk.PhotoImage(image)
        ...
        cadastrar_familiabio_button.pack(pady=35)

        image = Image.open('CADASTRO ABANDONO.png')
        photo = ImageTk.PhotoImage(image)
        ...
        cadastrar_abandono_button.pack(pady=35)
    ...
    def abrir_janela_crianca(self):
        ...
        remover_button = tk.Button(self.janela_crianca, command=self.deletar_crianca, text='Deletar Criança', font=('Quicksand', 30))
        remover_button.pack(pady=10, side='right')

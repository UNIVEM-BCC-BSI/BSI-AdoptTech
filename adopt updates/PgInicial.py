...
class Application(tk.Tk):
    ...
    def abrir_janela_consulta(self):
        ...
        self.janela_consulta.geometry('1280x960')
    ...
    def abrir_janela_cadastro(self):
        ...
        self.janela_cadastro.geometry('1280x960')
        ...
        cadastrar_crianca_button.pack(pady=50, fill='y')
        ...
        cadastrar_adocao_button.pack(pady=50, fill='y')
        ...
        cadastrar_familiaadot_button.pack(pady=50, fill='y')
        ...
        cadastrar_familiabio_button.pack(pady=50, fill='y')
        ...
        cadastrar_abandono_button.pack(pady=50, fill='y')
    ...
    def abrir_janela_familiabio(self):
        ...
        self.janela_familiabio.geometry('1280x960')
    ...
    def abrir_janela_familiaadot(self):
        ...
        self.janela_familiaadot.geometry('1280x960')

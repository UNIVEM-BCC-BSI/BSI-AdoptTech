...
class Application(tk.Tk):
    ...
    def abrir_janela_adocao(self):
        ...
        self.janela_adocao.geometry('1280x500')
        self.janela_adocao.resizable(width=False, height=False)
        ...
        realizar_button.image = photo
        realizar_button.pack(pady=10)
        realizar_button.place(x=480, y=340)
        ...
        voltar_button.pack(pady=10)
        voltar_button.place(x=550, y=430)
    ...
    def abrir_janela_crianca(self):
        ...
        self.janela_crianca.geometry('1280x610')
        self.janela_crianca.resizable(width=False, height=False)
        self.janela_crianca.configure(bg='#6598e4')

        nome_crianca_label = tk.Label(self.janela_crianca, text='Nome:', bg="#6598e4", font=('Roboto', 17))
        nome_crianca_label.pack(pady=7)
        nome_crianca_label.place(x=80, y=35)

        self.nome_crianca_entry = tk.Entry(self.janela_crianca, width=30)
        self.nome_crianca_entry.pack(pady=7)
        self.nome_crianca_entry.place(x=80, y=70)

        cpf_label = tk.Label(self.janela_crianca, text='CPF:', bg="#6598e4", font=('Roboto', 17))
        cpf_label.pack(pady=7)
        cpf_label.place(x=370, y=35)

        self.cpf_entry = tk.Entry(self.janela_crianca, width=30)
        self.cpf_entry.pack(pady=7)
        self.cpf_entry.place(x=370, y=70)

        rg_label = tk.Label(self.janela_crianca, text='RG:', bg="#6598e4", font=('Roboto', 17))
        rg_label.pack(pady=7)
        rg_label.place(x=610, y=35)

        self.rg_entry = tk.Entry(self.janela_crianca, width=30)
        self.rg_entry.pack(pady=7)
        self.rg_entry.place(x=610, y=70)

        hs_label = tk.Label(self.janela_crianca, text='Hist. Saúde:', bg="#6598e4", font=('Roboto', 17))
        hs_label.pack(pady=7)
        hs_label.place(x=930, y=35)

        self.hs_entry = tk.Entry(self.janela_crianca, width=30)
        self.hs_entry.pack(pady=7)
        self.hs_entry.place(x=930, y=70)

        pcd_label = tk.Label(self.janela_crianca, text='PCD:', bg="#6598e4" ,font=('Roboto', 17))
        pcd_label.pack(pady=7)
        pcd_label.place(x=80, y=150)

        self.pcd_entry = tk.Entry(self.janela_crianca, width=30)
        self.pcd_entry.pack(pady=7)
        self.pcd_entry.place(x=80, y=185)

        dn_label = tk.Label(self.janela_crianca, text='Data de Nascimento:', bg="#6598e4", font=('Roboto', 17))
        dn_label.pack(pady=7)
        dn_label.place(x=370, y=150)

        self.dn_entry = tk.Entry(self.janela_crianca, width=30)
        self.dn_entry.pack(pady=7)
        self.dn_entry.place(x=370, y=185)

        de_label = tk.Label(self.janela_crianca, text='Data de Entrada:', bg="#6598e4", font=('Roboto', 17))
        de_label.pack(pady=7)
        de_label.place(x=610, y=150)

        self.de_entry = tk.Entry(self.janela_crianca, width=30)
        self.de_entry.pack(pady=7)
        self.de_entry.place(x=610, y=185)
    ...
    def abrir_janela_abandono(self):
        ...
        self.janela_abandono.geometry('1280x500')
        self.janela_abandono.resizable(width=False, height=False)
